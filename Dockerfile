# docker buildx build -f Dockerfile -t pingdimasyudha/next-tauri-bun:2.0-1.0.0 -t pingdimasyudha/next-tauri-bun:latest --push --builder cloud-pingdimasyudha-pingdimasyudha --platform=linux/amd64,linux/arm64 .
# 12.7-slim
